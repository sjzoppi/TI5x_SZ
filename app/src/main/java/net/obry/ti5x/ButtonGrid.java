...
public class ButtonGrid extends android.view.View
  ...
  /* it appears SoundPool allocates loaded sound IDs starting from 1 */
    ...
    /**
     * SJZ/20161212
     * Added BOTH option for Button Feedback
     */
                  ...
                  switch (TheEvent.getAction())
                    {
                        ...
                        switch (KeyCode)
                          {
                            /**
                             * SJZ/20161213:
                             * We modify this entire handler to cycle through all
                             * of the options and pop up toast to indicate the setting
                             */
                            case android.view.KeyEvent.KEYCODE_VOLUME_DOWN:
                                if (FeedbackType == FEEDBACK_NONE)
                                  {
                                    FeedbackType = FEEDBACK_BOTH;
                                  } else {
                      ...
                      break; /*android.view.KeyEvent.ACTION_DOWN*/
                        ...
                        switch (KeyCode)
                          {
                            ...
                            case android.view.KeyEvent.KEYCODE_VOLUME_UP:
                              ...
                              {
                                case FEEDBACK_BOTH:
                                  Toast.makeText(TheView.getContext(), "Click and Vibrate", Toast.LENGTH_SHORT).show();
                                  break;
                                case FEEDBACK_CLICK:
                                  Toast.makeText(TheView.getContext(), "Click", Toast.LENGTH_SHORT).show();
                                  break;
                                case FEEDBACK_VIBRATE:
                                  Toast.makeText(TheView.getContext(), "Vibrate", Toast.LENGTH_SHORT).show();
                                  break;
                                case FEEDBACK_NONE:
                                  Toast.makeText(TheView.getContext(), "No Feedback", Toast.LENGTH_SHORT).show();
                                  break;
                              } /*switch (FeedbackType)*/
                              Handled = true;
                            break;
