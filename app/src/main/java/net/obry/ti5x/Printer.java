...
public class Printer
  {
    ...
    /*
     *  SJZ/20161114: Modified from 200 Lines to 150 lines
     *                because the canvas size is too large otherwise
    */
    final static int CharLines = 150; /* perhaps make this configurable? */
    ...
    public void SavePaper(android.content.Context ctx)
      /*
       *  SJZ/20161211: Clears and re-initializes the Paper Tape
       */
      {
        ...
        try
          ...
          catch (FileNotFoundException ex)
          {
            ...
            ex.printStackTrace();
            Toast.makeText(ctx, "Can't Create.", Toast.LENGTH_LONG).show();
          }
          finally
          {
            try
    ...
    public void ClearPaper(android.content.Context ctx)
      /*  SJZ/20161211 -
